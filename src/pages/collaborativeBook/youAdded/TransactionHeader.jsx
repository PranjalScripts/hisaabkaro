  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden">
      <div className="p-4 sm:p-8">
        <h1 className="text-2xl sm:text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent mb-4 sm:mb-8">
          Transaction Details
        </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white ring-1 ring-gray-200 rounded-xl p-4 sm:p-6 hover:shadow-lg transition-shadow duration-200">
              ...
              <p className="text-gray-700 font-medium truncate sm:text-clip">{bookName}</p>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white ring-1 ring-gray-200 rounded-xl p-4 sm:p-6 hover:shadow-lg transition-shadow duration-200">
              ...
              <p className="text-gray-700 font-medium truncate sm:text-clip">{userName}</p>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white ring-1 ring-gray-200 rounded-xl p-4 sm:p-6 hover:shadow-lg transition-shadow duration-200">
              ...
              <p className="text-gray-700 font-medium truncate sm:text-clip">{clientName}</p>
            </div>
          </div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-white ring-1 ring-gray-200 rounded-xl p-4 sm:p-6 hover:shadow-lg transition-shadow duration-200">
              ...
              <p className="text-gray-700 font-medium">{Math.abs(outstandingBalance).toLocaleString('en-IN')}</p>
            </div>
          </div>
        </div>
      </div>
