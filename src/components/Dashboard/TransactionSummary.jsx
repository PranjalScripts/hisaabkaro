  ...
  return (
    <div className="mb-4 md:mb-6">
      ...
      <div className="grid grid-cols-3 md:grid-cols-3 gap-2 md:gap-4 px-2 md:px-0 max-w-5xl mx-auto">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-green-50 to-emerald-50 p-2 md:p-3.5 rounded-lg shadow-sm border border-green-100 hover:shadow-md transition-all duration-300">
          <div className="relative">
            <div className="flex items-center justify-between mb-1 md:mb-2">
              <h3 className="text-xs md:text-sm font-medium text-green-800 truncate pr-1 md:pr-2">
                {t("transactions.totalYouWillGet")}
              </h3>
              <div className="p-1 md:p-1.5 bg-green-100 rounded-md flex-shrink-0">
                <AiOutlineArrowDown className="w-3 h-3 md:w-4 md:h-4 text-green-600" />
              </div>
            </div>
            <p className="text-base md:text-2xl font-bold text-green-600 mb-0.5 md:mb-1">
            ...
            {unconfirmedWillGet > 0 && (
              <div className="flex items-center text-[10px] md:text-xs bg-white/50 rounded-md p-1 md:p-1.5">
                <AiOutlineClockCircle className="w-2.5 h-2.5 md:w-3.5 md:h-3.5 text-green-500 mr-0.5 md:mr-1" />
                <span className="text-green-600 font-medium">+</span>
                <span className="text-green-600 font-medium ml-0.5 md:ml-1">
                   {unconfirmedWillGet.toLocaleString('en-IN')}
                </span>
                <span className="text-green-500 ml-0.5 md:ml-1 hidden md:inline">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-red-50 to-rose-50 p-2 md:p-3.5 rounded-lg shadow-sm border border-red-100 hover:shadow-md transition-all duration-300">
          <div className="relative">
            <div className="flex items-center justify-between mb-1 md:mb-2">
              <h3 className="text-xs md:text-sm font-medium text-red-800 truncate pr-1 md:pr-2">
                {t("transactions.totalYouWillGive")}
              </h3>
              <div className="p-1 md:p-1.5 bg-red-100 rounded-md flex-shrink-0">
                <AiOutlineArrowUp className="w-3 h-3 md:w-4 md:h-4 text-red-600" />
              </div>
            </div>
            <p className="text-base md:text-2xl font-bold text-red-600 mb-0.5 md:mb-1">
            ...
            {unconfirmedWillGive > 0 && (
              <div className="flex items-center text-[10px] md:text-xs bg-white/50 rounded-md p-1 md:p-1.5">
                ...
                <span className="text-red-500 ml-0.5 md:ml-1 hidden md:inline">
                  {t("transactions.unconfirmed")}
                </span>
              </div>
            )}
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-blue-50 to-indigo-50 p-2 md:p-3.5 rounded-lg shadow-sm border border-blue-100 hover:shadow-md transition-all duration-300">
          <div className="relative">
            <div className="flex items-center justify-between mb-1 md:mb-2">
              ...
              <div className="p-1 md:p-1.5 bg-blue-100 rounded-md flex-shrink-0">
                <AiOutlineSwap className="w-3 h-3 md:w-4 md:h-4 text-blue-600" />
              </div>
            </div>
            <p className={`text-base md:text-2xl font-bold mb-0.5 md:mb-1 ${
            ...
            {(unconfirmedWillGet > 0 || unconfirmedWillGive > 0) && (
              <div className="flex items-center text-[10px] md:text-xs bg-white/50 rounded-md p-1 md:p-1.5">
                ...
                <span className={`font-medium ml-0.5 md:ml-1 ${
